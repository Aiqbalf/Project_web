...
document.querySelector(".tab").innerHTML = `<p class="all">All Product</p>${[
  ...new Set(
...
function addToCart() {
  ...
  const productCategory = document.querySelector(".popup .category").textContent;
  ...
  if (existingProductIndex !== -1) {
    ...
    cartItems[existingProductIndex].quantity = parseInt(cartItems[existingProductIndex].quantity) + parseInt(productQuantity);
  } else {
